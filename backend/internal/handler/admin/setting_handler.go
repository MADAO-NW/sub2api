...
func (h *SettingHandler) GetSettings(c *gin.Context) {
	...
	payload := dto.SystemSettings{
		...
		UserQuotaFollowAccountResetEnabled:            settings.UserQuotaFollowAccountResetEnabled,
		UserQuotaFollowAccountResetWeeklyEnabled:      settings.UserQuotaFollowAccountResetWeeklyEnabled,
		UserQuotaFollowAccountResetDailyEnabled:       settings.UserQuotaFollowAccountResetDailyEnabled,
		UserQuotaFollowAccountResetMinIntervalMinutes: settings.UserQuotaFollowAccountResetMinIntervalMinutes,
		UserQuotaFollowAccountResetMaxIntervalMinutes: settings.UserQuotaFollowAccountResetMaxIntervalMinutes,
