export default {
  promptAudit: {
    ...
    runtime: {
      ...
      modelMetrics: 'Per-model runtime metrics', orderedAllHint: 'Every enabled model runs once in list order',
    ...
    pool: {
      title: 'Configured audit models', description: 'Every enabled model runs once in list order. Probes run from the server network.',
    ...
    auditPrompt: {
      ...
      description: 'The third-party system prompt is the current admin audit prompt, two newlines, and the backend-owned fixed output protocol.',
    ...
    policy: {
      ...
      strategyHint: 'Every enabled model runs once in configured order. Order carries no weight, and execution does not stop when the threshold is reached early.',
    ...
    events: {
      ...
      technical: {
        ...
        partialFailure: 'Some models failed', promptContract: 'Fixed protocol version / audit prompt hash',
