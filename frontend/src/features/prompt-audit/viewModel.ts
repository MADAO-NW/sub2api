...
export function buildUpdateRequest(draft: PromptAuditDraft): PromptAuditUpdateRequest {
  return {
    ...
    audit_prompt: draft.audit_prompt,
    ...
    notifications: { admin_email: draft.notifications.admin_email },
    enforcement: {
      email_warning: {
        enabled: draft.enforcement.email_warning.enabled,
        lookback_count: Number(draft.enforcement.email_warning.lookback_count),
        violation_threshold: Number(draft.enforcement.email_warning.violation_threshold),
      },
      account_disable: {
        enabled: draft.enforcement.account_disable.enabled,
        violation_threshold: Number(draft.enforcement.account_disable.violation_threshold),
      },
    },
